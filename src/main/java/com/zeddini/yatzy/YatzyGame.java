...
/**
 * La classe principale pour exécuter l'application "le jeu Yatzy" ou Yatzy Game.
...
public class YatzyGame {
    ...
    /**
     * Le point d'entrée principal pour l'application "le jeu Yatzy".
     * La méthode main démontre l'utilisation des stratégies de scoring pour toutes les catégories 
     * telles que "Chance", .... jusqu'à "Full House"!
     *
     */
    public static void main(String[] args) {
       ...
       // Utilisation de la catégorie "ThreeOfAKind" pour le scoring
